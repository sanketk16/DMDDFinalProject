...
CREATE TABLE passenger (
	...
	fname VARCHAR(50),
	lname VARCHAR(50),
	email VARCHAR(50) CONSTRAINT em CHECK (email LIKE '%@%.%'),
	drivers_license VARCHAR(50),
	date_of_birth DATE CONSTRAINT chk_date_of_birth CHECK (date_of_birth > TO_DATE ('1950/01/01', 'YYYY/MM/DD')),
	location VARCHAR(50) CONSTRAINT chk_location CHECK (LENGTH (location) = 5),
...
create table car (
	...
	brand VARCHAR(50),
	licNO VARCHAR(50),
	mfgyear VARCHAR(25) CONSTRAINT chk_mfgyear CHECK (LENGTH (mfgyear) = 4),
	color VARCHAR(50),
    car_category VARCHAR(9) CONSTRAINT chk_category CHECK (car_category IN ('sedan', 'hatchback', 'SUV', 'minivan')),
...
create table parking_lot (
	lotNO INT NOT NULL,
	location VARCHAR(50) CONSTRAINT chk_prkloc CHECK (LENGTH (location) = 5),
	lotname VARCHAR(50),
...
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (1, '2021-12-01 07:19:17', '2021-12-06 09:04:43', 39, 115, 7);
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (2, '2021-04-18 09:27:09', '2021-04-22 10:37:20', 90, 180, 11);
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (3, '2022-01-13 07:55:39', '2022-01-18 07:20:53', 118, 95, 6);
...
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (15, '2021-08-25 20:30:58', '2021-08-30 02:26:04', 149, 238, 15);
...
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (17, '2022-02-25 23:07:44', '2022-02-28 11:29:48', 26, 12, 21);
...
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (47, '2021-06-07 06:22:57', '2021-06-07 11:46:39', 59, 163, 2);
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (48, '2021-08-13 10:41:47', '2021-08-13 18:11:28', 1, 29, 14);
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (49, '2022-04-13 17:35:44', '2022-04-15 16:42:55', 74, 17, 14);
insert into reservation (reservationID, pickup_date, return_date, passengerID, carID, lotNO) values (50, '2021-07-17 11:11:45', '2021-07-17 20:02:15', 120, 75, 2);
...
GRANT SELECT ON parking_lot TO employee;
GRANT SELECT ON user_review TO employee;
GRANT SELECT ON emp_department TO employee;
